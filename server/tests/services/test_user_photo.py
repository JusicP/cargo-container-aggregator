...
async def test_check_rights_and_delete_user_photo(session: AsyncSession):
    await create_user(session, UserCreate(name="user1", password="pass1", email="u1@test.com", phone_number="111", company_name="C1"))
    await create_user(session, UserCreate(name="user2", password="pass2", email="u2@test.com", phone_number="222", company_name="C2"))
