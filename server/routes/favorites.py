...
from server.services.listing_history_service import decrement_favorites, increment_favorites
...
async def add_to_favorites(
    ...
    try:
        ...
        await increment_favorites(session, listing_id)
...
async def remove_from_favorites(
    ...
    try:
        ...
        await decrement_favorites(session, listing_id)
